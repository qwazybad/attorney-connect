...
export default function ForAttorneysCTA() {
  ...
  return (
    <section ref={ref} className="relative py-24 bg-gray-800 overflow-hidden">
      {/* Orbs */}
      <div className="orb orb-indigo animate-glow-pulse w-[500px] h-[500px] -top-20 -right-20 opacity-40" />
      <div className="orb orb-blue animate-float-slow w-[400px] h-[400px] bottom-0 -left-20 opacity-30" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="reveal reveal-delay-3 flex flex-col sm:flex-row gap-3">
              <Link href="/join" className="inline-flex items-center justify-center gap-2 bg-accent-500 hover:bg-accent-600 text-white font-bold px-6 py-3.5 rounded-2xl transition-all duration-200 hover:shadow-[0_4px_24px_rgba(5,150,105,0.4)]">
