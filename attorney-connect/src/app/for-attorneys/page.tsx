...
export default function ForAttorneysPage() {
  ...
  const [leadCostPerLead, setLeadCostPerLead] = useState(800);
      ...
      <section ref={calcRef} className="py-20 bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-5 sm:px-8">
          ...
          <div className="reveal reveal-delay-1 bg-gray-50 rounded-2xl p-6 border border-gray-100 mb-6 space-y-6">
            ...
            {calcMode === "flat-plus" && (<>
              <SliderField label="Cost per lead" value={leadCostPerLead} min={200} max={2000} step={50} format={fmt} onChange={setLeadCostPerLead} />
          ...
          <div className="reveal reveal-delay-2 grid grid-cols-3 gap-3 text-center">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-3 sm:p-5">
              <p className="text-xs text-gray-400 font-semibold mb-2">Our Rate</p>
